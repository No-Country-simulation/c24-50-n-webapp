    ...
    <svg viewBox="0 0 1920 3500" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_14_3826)">
            <g filter="url(#filter1_f_14_3826)">
                <ellipse cx="-112" cy="759.5" rx="400" ry="498.5" fill="#6158FF" />
            </g>
        </g>
        <g filter="url(#filter2_f_14_3826)">
            <ellipse cx="776" cy="33" rx="395" ry="267" fill="#6158FF" fill-opacity="0.8" />
        </g>
        <defs>
            <filter id="filter0_f_14_3826" x="723" y="-231" width="1295" height="1295" filterUnits="userSpaceOnUse"
            ...
            <filter id="filter2_f_14_3826" x="-24" y="-639" width="1600" height="3500" filterUnits="userSpaceOnUse"
                ...
                <feFlood flood-opacity="0" result="BackgroundImageFix" />
                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                <feGaussianBlur stdDeviation="202.5" result="effect1_foregroundBlur_14_3826" />
            </filter>
            <linearGradient id="paint0_linear_14_3826" x1="0" y1="0" x2="546.828" y2="-510.343"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#362FCC" />
                <stop offset="1" stop-color="#5D55FF" />
            </linearGradient>
            <linearGradient id="paint1_linear_14_3826" x1="0" y1="0" x2="305.375" y2="-600.079"
                gradientUnits="userSpaceOnUse">
